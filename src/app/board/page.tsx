...
export default function BoardPage() {
  ...
  useEffect(() => {
    if (pageCount <= 1) { setCurrentPage(0); return; }
  ...
  return (
    <div style={{
      ...
      height: "100dvh", background: "#f8fafc", color: "#000000",
...
/>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <span style={{ fontSize: 14, color: "rgba(0, 0, 0, 0.6)", letterSpacing: 1 }}>
            Bemorlar joylashuvi
          </span>
          <span style={{
            background: "rgba(0, 0, 0, 0.04)", padding: "2px 8px", borderRadius: "12px",
            fontSize: "11px", color: "rgba(0, 0, 0, 0.4)", letterSpacing: 0.5
          }}>
            Jami: {data.length}
          </span>
        </div>
      ...
      <main ref={mainRef} style={{
        ...
        {loading && <Center><Muted>Yuklanmoqda...</Muted></Center>}
        {!loading && error && <Center><Muted>Ma&apos;lumot yuklanmadi. Sahifani yangilang.</Muted></Center>}
        {!loading && !error && data.length === 0 && <Center><Muted>Hozircha bemorlar yo&apos;q</Muted></Center>}
        ...
        {pageCount > 1 && (
          <div style={{
            ...
            <div
              ...
              style={{
                height: "100%", background: "rgba(0, 0, 0, 0.28)",
      ...
      {/* ─── Footer ─── */}
      <footer style={{
        height: 36, borderTop: "1px solid rgba(0, 0, 0, 0.05)",
        display: "flex", alignItems: "center", justifyContent: "space-between",
        padding: "0 28px", flexShrink: 0, background: "#ffffff"
      }}>
        <span style={{ fontSize: 11, color: "rgba(0, 0, 0, 0.3)", letterSpacing: 1 }}>
          Jami:{" "}
          <b style={{ color: "rgba(0, 0, 0, 0.6)", fontWeight: 500 }}>{data.length}</b> bemor
        </span>
...
function Muted({ children }: { children: React.ReactNode }) {
  return (
    <p style={{ fontSize: 22, color: "rgba(0, 0, 0, 0.3)", fontWeight: 300, margin: 0 }}>
      {children}
    </p>
  );
}
