...
import { InvoiceStatus } from "@/features/invoices/style-colors";
import { INVOICE_STATUS_CONFIG } from "@/features/invoices/types";
...
function CreateInvoiceForm({ patients, onSubmit, onCancel, isLoading }: { patients: Patient[]; onSubmit: (data: any) => void; onCancel: () => void; isLoading: boolean }) {
