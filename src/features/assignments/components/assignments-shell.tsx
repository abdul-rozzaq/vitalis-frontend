...
export function AssignmentsShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="p-6 space-y-5 max-w-7xl mx-auto w-full">
      ...
      <motion.div initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.04 }} className="flex items-center gap-1 bg-surface border border-border p-1 rounded-xl w-fit">
