    ...
    <div className="bg-surface border border-border rounded-xl p-6 space-y-5">
      ...
      {!qzAvailable && qzAvailable !== null && (
        <p className="text-xs text-text-muted rounded-lg bg-warning-50 px-3 py-2">
          QZ Tray kompyuterda ishlamayapti. Kompyuterda QZ Tray dasturi o'rnatilgan va ishga tushirilganini tekshiring. QZ Tray bo'lmasa to'lov oynasidagi chek funksiyasi brauzerning print oynasi orqali ishlaydi.
        </p>
      )}
    </div>
  );
