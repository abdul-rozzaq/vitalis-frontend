...
// Chek chiqarish (shu jumladan bu sozlamalar kartasi) hozircha butunlay o'chirilgan.
// Komponent hech qayerda render qilinmaydi (qarang: src/app/settings/page.tsx).
// // QZ Tray / Xprinter hozircha o'chirilgan (printer xatolik beryapti) - bu komponent
// // src/app/settings/page.tsx da endi render qilinmaydi.
